...
typedef struct {
  ...
  u8 cmdCount;      // 0x01
  u16 cmdOffset;    // 0x02, この Animation を持つ 　AnimationFile の先頭から、 最初のコマンドへのバイトオフセット
} Animation;
