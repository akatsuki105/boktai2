...
typedef struct Entity9A9F {
  ...
  u8 unk_38[4];                 // 0x038
  s32 unk_3c;                   // 0x03C, VM_GetKeywordValue('L', 5000)
  u8 unk_40[2];                 // 0x040
  ...
  s16 unk_154[4];               // 0x154, script keyword 'e' があればそこから、無ければ {2, 1, -1, -2}
  u8 unk_15c[23];               // 0x15C
  ...
  u8 unk_2d8[4];                // 0x2D8
  s16 unk_2dc;                  // 0x2DC, VM_GetKeywordValue('l', 0)
  s16 unk_2de;                  // 0x2DE, VM_GetKeywordValue('R', 0)
  s16 unk_2e0;                  // 0x2E0, VM_GetKeywordValue('v', 0)
  s16 unk_2e2;                  // 0x2E2, VM_GetKeywordValue('r', 0)
  s16 unk_2e4;                  // 0x2E4, VM_GetKeywordValue('b', 0)
  s16 exitScriptID;             // 0x2E6, VM_GetKeywordValue('E', 0)。終了時に Script_ExecById で実行する。0 ならソフトリセット
  s16 unk_2e8;                  // 0x2E8, VM_GetKeywordValue('Y', 0)
  s16 unk_2ea;                  // 0x2EA, VM_GetKeywordValue('U', 0)
  u8* unk_2ec;                  // 0x2EC, script keyword 's' の後の FUN_0823d340()
  u8* unk_2f0;                  // 0x2F0, script keyword 'S' の後の FUN_0823d340()
} Entity9A9F;
