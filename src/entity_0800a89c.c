...
// PTR_ARRAY_085aa730 の中身。frameBit/framePhase は Entity0800a89c.unk_1c の下位ビットで、
...
typedef void (*SpiritBugHandler)(Entity0800a89c* p, SpiritBugSwarm* swarm, s32 bugIdx, u32 frameBit, u32 framePhase, void* screenBox);

void FUN_0800b064(Entity0800a89c* p, SpiritBugSwarm* swarm, s32 bugIdx, u32 frameBit, u32 framePhase, void* screenBox);
void FUN_0800b068(Entity0800a89c* p, SpiritBugSwarm* swarm, s32 bugIdx, u32 frameBit, u32 framePhase, void* screenBox);
void FUN_0800b7a0(Entity0800a89c* p, SpiritBugSwarm* swarm, s32 bugIdx, u32 frameBit, u32 framePhase, void* screenBox);
void FUN_0800be38(Entity0800a89c* p, SpiritBugSwarm* swarm, s32 bugIdx, u32 frameBit, u32 framePhase, void* screenBox);
void Entity0800a89c_UpdateCollectedBug(Entity0800a89c* p, SpiritBugSwarm* swarm, s32 bugIdx, u32 frameBit, u32 framePhase, void* screenBox);
void FUN_0800b404(Entity0800a89c* p, SpiritBugSwarm* swarm, s32 bugIdx, u32 frameBit, u32 framePhase, void* screenBox);
void FUN_0800ba78(Entity0800a89c* p, SpiritBugSwarm* swarm, s32 bugIdx, u32 frameBit, u32 framePhase, void* screenBox);
...
s32 Entity0800a89c_ReleaseSwarm(Entity0800a89c* p, SpiritBugSwarm* swarm) {
  s32 i;

  for (i = 0; i < 4; i++) {
    FUN_0822dabc(&swarm->bugs[i].ptcl);
  }
  swarm->active = 0;
}
...
s32 Entity0800a89c_ReleaseAll(void) {
  Entity0800a89c* p = gEntity0800a89c;
  s32 i;
...
s32 Entity0800a89c_UpdateSwarm(Entity0800a89c* p, SpiritBugSwarm* swarm, void* screenBox) {
...
NAKED s32 Entity0800a89c_Update(Entity0800a89c* p) { INCFUNC("asm/func/Entity0800a89c_Update.inc"); }

s32 Entity0800a89c_Destroy(Entity0800a89c* p) {
  s32 i;
  s32 j;
  ...
  for (i = 0; i < 6; i++) {
    ...
    if (swarm->active) {
      for (j = 0; j < 4; j++) {
        FUN_0822dabc(&swarm->bugs[j].ptcl);
      }
    }
  }
  gEntity0800a89c = NULL;
  return 0;
}

// 群れ6つ分の Particle を確保し、サバタかどうかを覚えておく (使うアニメーションが変わる)
s32 Entity0800a89c_Init(Entity0800a89c* p, unknown* arg) {
  Player* player;
  s32 i;
  s32 j;
  ...
  p->anim_24 = GetFile(DIR_ANIMATION, 0xD1B8);
  for (i = 0; i < 6; i++) {
    SpiritBugSwarm* swarm = &p->swarms[i];
...
Entity0800a89c* Entity0800a89c_Create(unknown* arg) {
  Entity0800a89c* p = CreateEntity(ENTITY_UNK_8, sizeof(Entity0800a89c));
    ...
    if (swarm->active && swarm->kind == 2) {
      ...
      for (j = 0; j < 4; j++) {
        if (swarm->bugs[j].state != 0) {
          FUN_08236fac(&swarm->bugs[j].anim, p->anim_24, u16_ARRAY_085aa6d0[(p->isSabata * 3 + swarm->kind) * 2], 0, 0);
...
NAKED void FUN_0800b068(Entity0800a89c* p, SpiritBugSwarm* swarm, s32 bugIdx, u32 frameBit, u32 framePhase, void* screenBox) { INCFUNC("asm/func/FUN_0800b068.inc"); }

NAKED void FUN_0800b404(Entity0800a89c* p, SpiritBugSwarm* swarm, s32 bugIdx, u32 frameBit, u32 framePhase, void* screenBox) { INCFUNC("asm/func/FUN_0800b404.inc"); }

NAKED void FUN_0800b7a0(Entity0800a89c* p, SpiritBugSwarm* swarm, s32 bugIdx, u32 frameBit, u32 framePhase, void* screenBox) { INCFUNC("asm/func/FUN_0800b7a0.inc"); }

NAKED void FUN_0800ba78(Entity0800a89c* p, SpiritBugSwarm* swarm, s32 bugIdx, u32 frameBit, u32 framePhase, void* screenBox) { INCFUNC("asm/func/FUN_0800ba78.inc"); }

// state 4 (プレイヤーに回収された) のハンドラ。アニメを1コマ進め、一巡したら虫を消す
NON_MATCH void Entity0800a89c_UpdateCollectedBug(Entity0800a89c* p, SpiritBugSwarm* swarm, s32 bugIdx, u32 frameBit, u32 framePhase, void* screenBox) {
#ifdef NONMATCHING_C
...
NAKED void FUN_0800be38(Entity0800a89c* p, SpiritBugSwarm* swarm, s32 bugIdx, u32 frameBit, u32 framePhase, void* screenBox) { INCFUNC("asm/func/FUN_0800be38.inc"); }
