...
_08052914:
	...
	thumb_func_start FUN_0805291c
FUN_0805291c: @ 0x0805291C
	push {r4, r5, r6, lr}
	adds r5, r0, #0
	bl FUN_0804e59c
	cmp r0, #0
...
_08052960: .4byte 0x085AB724
	...
	thumb_func_start FUN_08052964
FUN_08052964: @ 0x08052964
	push {r4, r5, r6, lr}
	adds r6, r0, #0
	adds r4, r6, #0
	adds r4, #0x70
...
_080529AC: .4byte 0x0300011C
	...
	thumb_func_start FUN_080529b0
FUN_080529b0: @ 0x080529B0
	push {r4, r5, r6, r7, lr}
	mov r7, sl
	mov r6, sb
	mov r5, r8
...
_08052AEC: .4byte 0x000008D8
	...
	thumb_func_start FUN_08052af0
FUN_08052af0: @ 0x08052AF0
	push {r4, lr}
	bl FUN_080522c4
	adds r4, r0, #0
	cmp r4, #0
	...
	cmp r4, #0
	beq _08052B34
	ldr r1, _08052B2C @ =FUN_0805291c
	ldr r2, _08052B30 @ =FUN_08052964
	bl SetEntityRoutine
	adds r0, r4, #0
	bl FUN_080529b0
	cmp r0, #0
...
_08052B2C: .4byte FUN_0805291c
_08052B30: .4byte FUN_08052964
_08052B34:
	adds r0, r4, #0
_08052B36:
	pop {r4}
