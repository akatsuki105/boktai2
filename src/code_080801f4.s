...
_0808A00C:
	...
	thumb_func_start Entity28CB_Update
Entity28CB_Update: @ 0x0808A018
	push {r4, r5, r6, r7, lr}
	adds r4, r0, #0
...
_0808A0E0:
	...
	thumb_func_start Entity28CB_Destroy
Entity28CB_Destroy: @ 0x0808A0E8
	push {r4, r5, r6, lr}
	adds r6, r0, #0
	adds r4, r6, #0
	adds r4, #0x74
...
_0808A134:
	...
	thumb_func_start Entity28CB_Init
Entity28CB_Init: @ 0x0808A13C
	push {r4, r5, r6, r7, lr}
	mov r7, sl
	mov r6, sb
	mov r5, r8
...
_0808A2F4: .4byte 0x04000008
	...
	thumb_func_start Entity28CB_Create
Entity28CB_Create: @ 0x0808A2F8
	push {r4, r5, lr}
	adds r5, r0, #0
	movs r1, #0xc8
	lsls r1, r1, #1
	...
	cmp r4, #0
	beq _0808A334
	ldr r1, _0808A32C @ =Entity28CB_Update
	ldr r2, _0808A330 @ =Entity28CB_Destroy
	bl SetEntityRoutine
	adds r0, r4, #0
	adds r1, r5, #0
	bl Entity28CB_Init
	...
	b _0808A336
	.align 2, 0
_0808A32C: .4byte Entity28CB_Update
_0808A330: .4byte Entity28CB_Destroy
_0808A334:
	adds r0, r4, #0
_0808A336:
	pop {r4, r5}
