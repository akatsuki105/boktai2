...
SoundMain: @ 0x08243AA8
	ldr r0, _08243B14 @ =SOUND_INFO_PTR
	ldr r0, [r0]
...
_08243B0A:
	...
	bx r3
	.align 2, 0
_08243B14: .4byte SOUND_INFO_PTR
...
_08243B48:
	...
	subs r4, r4, #1
	bgt _08243B48
	adr r0, _08243B96 + 1 @ plus 1 because THUMB
	bx r0

	.thumb
SoundMainRAM_NoReverb: @ 0x08243B78
	movs r0, #0
	mov r1, r8
	lsrs r1, r1, #3
	blo _08243B82
...
_08243E2C:
	ldr r8, [sp]
	add r0, pc, #0x1 @ =_08243E38
	bx r0

	.thumb
_08243E38: @ 0x08243E38
	ldr r0, [sp, #4]
	subs r0, #1
	ble _08243E42
	adds r4, #0x40
...
MPlayJumpTableCopy: @ 0x08243ECC
	mov ip, lr
	movs r1, #0x24
	ldr r2, _08243EFC @ =gMPlayJumpTableTemplate
_08243ED2:
	ldr r3, [r2]
	bl _08243EE6
	stm r0!, {r3}
...
_08243EE6:
	...
	lsrs r0, r2, #0x19
	bne _08243EF8
	ldr r0, _08243EFC @ =gMPlayJumpTableTemplate
	cmp r2, r0
	blo _08243EF6
	lsrs r0, r2, #0xe
	beq _08243EF8
...
_082440AC:
	...
	b _082442EC
_082440C4:
	ldr r0, _08244304 @ =SOUND_INFO_PTR
	ldr r0, [r0]
	mov r8, r0
	adds r0, r7, #0
	bl FadeOutBody
...
FUN_082442fc: @ 0x082442FC
	bx r3
	.align 2, 0
_08244300: .4byte gClockTable
_08244304: .4byte SOUND_INFO_PTR
...
_08244320:
	...
	ands r0, r3
	beq _08244338
	ldr r3, _08244354 @ =SOUND_INFO_PTR
	ldr r3, [r3]
	ldr r3, [r3, #0x2c]
	bl FUN_082442fc
_08244338:
...
_0824434E:
	...
	bx r0
	.align 2, 0
_08244354: .4byte SOUND_INFO_PTR
...
ply_note: @ 0x08244388
	...
	str r1, [sp]
	adds r5, r2, #0
	ldr r1, _08244580 @ =SOUND_INFO_PTR
	ldr r1, [r1]
	str r1, [sp, #4]
	ldr r1, _08244584 @ =gClockTable
	adds r0, r0, r1
	ldrb r0, [r0]
	strb r0, [r5, #4]
	ldr r3, [r5, #0x40]
...
_0824456E:
	...
	bx r0
	.align 2, 0
_08244580: .4byte SOUND_INFO_PTR
_08244584: .4byte gClockTable
