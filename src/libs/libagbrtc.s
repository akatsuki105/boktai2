...
@ agbrtc.a
	...
	thumb_func_start RtcIoEnable
RtcIoEnable: @ 0x0824C598
	push {r7, lr}
	mov r7, sp
	bl GpioReadEnable
...
_0824C5AC: .4byte rtc_lock
	...
	thumb_func_start RtcIoDisable
RtcIoDisable: @ 0x0824C5B0
	push {r7, lr}
	mov r7, sp
	bl GpioReadDisable
...
_0824C5C4: .4byte rtc_lock
	...
	thumb_func_start RtcPowerOnCheck
RtcPowerOnCheck: @ 0x0824C5C8
	push {r7, lr}
	sub sp, #0x10
	mov r7, sp
	adds r1, r7, #4
...
_0824C71C:
	...
	thumb_func_start RtcReadStat
RtcReadStat: @ 0x0824C724
	push {r4, r7, lr}
	sub sp, #8
	mov r7, sp
	str r0, [r7]
...
_0824C7E8:
	...
	thumb_func_start RtcWriteStat
RtcWriteStat: @ 0x0824C7F0
	push {r4, r7, lr}
	sub sp, #8
	mov r7, sp
	str r0, [r7]
...
_0824C890:
	...
	thumb_func_start RtcReadDate
RtcReadDate: @ 0x0824C898
	push {r7, lr}
	sub sp, #8
	mov r7, sp
	str r0, [r7]
...
_0824C940:
	...
	thumb_func_start RtcWriteDate
RtcWriteDate: @ 0x0824C948
	push {r7, lr}
	sub sp, #8
	mov r7, sp
	str r0, [r7]
...
_0824C9DC:
	...
	thumb_func_start RtcReadTime
RtcReadTime: @ 0x0824C9E4
	push {r7, lr}
	sub sp, #8
	mov r7, sp
	str r0, [r7]
...
_0824CA90:
	...
	thumb_func_start RtcWriteTime
RtcWriteTime: @ 0x0824CA98
	push {r7, lr}
	sub sp, #8
	mov r7, sp
	str r0, [r7]
...
_0824CB2C:
	...
	thumb_func_start RtcWriteAlarm
RtcWriteAlarm: @ 0x0824CB34
	push {r4, r7, lr}
	sub sp, #0xc
	mov r7, sp
	str r0, [r7]
...
_0824CC60:
	...
	thumb_func_start RtcWriteCom
RtcWriteCom: @ 0x0824CC68
	push {r4, r5, r7, lr}
	sub sp, #4
	mov r7, sp
	adds r1, r0, #0
...
_0824CD04:
	...
	thumb_func_start RtcWriteData
RtcWriteData: @ 0x0824CD0C
	push {r4, r7, lr}
	sub sp, #4
	mov r7, sp
	adds r1, r0, #0
...
_0824CDA4:
	...
	thumb_func_start RtcReadData
RtcReadData: @ 0x0824CDAC
	push {r7, lr}
	sub sp, #4
	mov r7, sp
	adds r0, r7, #0
...
_0824CE30:
	...
	thumb_func_start GpioReadEnable
GpioReadEnable: @ 0x0824CE38
	push {r7, lr}
	mov r7, sp
...
_0824CE48: .4byte ROM_GPIOCNT
	...
	thumb_func_start GpioReadDisable
GpioReadDisable: @ 0x0824CE4C
	push {r7, lr}
	mov r7, sp
