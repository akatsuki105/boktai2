...
typedef struct {
  ...
  u16 id;              // 0x018
  u16 unk_1a;          // 0x01A, '.t=0', FUN_0822ee58 の第1引数
  u16 unk_1c;          // 0x01C, '.m=0', FUN_0822ee58 の第2引数
  u8 unk_1e;           // 0x01E, '.r[0]' の1番目
  u8 unk_1f;           // 0x01F, '.r[1]=160' の2番目
  s16 phaseStep;       // 0x020, '.o=2', 1tick ごとに phase へ加える
