...
_0809E9E8:
	...
	thumb_func_start Entity0809eb24_Update
Entity0809eb24_Update: @ 0x0809E9EC
	push {r4, lr}
	adds r4, r0, #0
	adds r1, r4, #0
	adds r1, #0x29
...
_0809EA8C: .4byte 0x03002BF0
	...
	thumb_func_start Entity0809eb24_Destroy
Entity0809eb24_Destroy: @ 0x0809EA90
	push {r4, r5, lr}
	adds r4, r0, #0
	movs r5, #0
	b _0809EAB4
...
_0809EAEE:
	...
	thumb_func_start Entity0809eb24_Init
Entity0809eb24_Init: @ 0x0809EAF4
	push {r4, lr}
	adds r4, r0, #0
	bl FUN_0809eacc
	movs r1, #0
...
_0809EB20: .4byte 0x03000140
	...
	thumb_func_start Entity0809eb24_Create
Entity0809eb24_Create: @ 0x0809EB24
	push {r4, r5, r6, lr}
	adds r5, r0, #0
	adds r6, r1, #0
	...
	cmp r4, #0
	beq _0809EB64
	ldr r1, _0809EB5C @ =Entity0809eb24_Update
	ldr r2, _0809EB60 @ =Entity0809eb24_Destroy
	bl SetEntityRoutine
	adds r0, r4, #0
	adds r1, r5, #0
	adds r2, r6, #0
	bl Entity0809eb24_Init
	cmp r0, #0
	bge _0809EB64
	adds r0, r4, #0
	bl KillEntity
...
_0809EB5C: .4byte Entity0809eb24_Update
_0809EB60: .4byte Entity0809eb24_Destroy
_0809EB64:
	adds r0, r4, #0
_0809EB66:
	pop {r4, r5, r6}
...
_0809EE12:
	...
	thumb_func_start Entity0809eeb4_Update
Entity0809eeb4_Update: @ 0x0809EE18
	push {r4, lr}
	adds r4, r0, #0
...
_0809EE46:
	...
	thumb_func_start Entity0809eeb4_Destroy
Entity0809eeb4_Destroy: @ 0x0809EE54
	push {r4, r5, lr}
	adds r4, r0, #0
	movs r5, #0
	b _0809EE78
...
_0809EE8C: .4byte 0x03000140
	...
	thumb_func_start Entity0809eeb4_Init
Entity0809eeb4_Init: @ 0x0809EE90
	adds r2, r0, #0
	adds r2, #0x26
	movs r1, #0
	strb r1, [r2]
...
_0809EEB0: .4byte 0x03000140
	...
	thumb_func_start Entity0809eeb4_Create
Entity0809eeb4_Create: @ 0x0809EEB4
	push {r4, r5, r6, lr}
	adds r5, r0, #0
	adds r6, r1, #0
	...
	cmp r4, #0
	beq _0809EEF4
	ldr r1, _0809EEEC @ =Entity0809eeb4_Update
	ldr r2, _0809EEF0 @ =Entity0809eeb4_Destroy
	bl SetEntityRoutine
	adds r0, r4, #0
	adds r1, r5, #0
	adds r2, r6, #0
	bl Entity0809eeb4_Init
	cmp r0, #0
	bge _0809EEF4
	adds r0, r4, #0
	bl KillEntity
...
_0809EEEC: .4byte Entity0809eeb4_Update
_0809EEF0: .4byte Entity0809eeb4_Destroy
_0809EEF4:
	adds r0, r4, #0
_0809EEF6:
	pop {r4, r5, r6}
	...
	thumb_func_start VM_Sub5CCC
VM_Sub5CCC: @ 0x0809EEFC
	push {lr}
	adds r2, r0, #0
	adds r3, r1, #0
...
_080A6B80:
	...
	thumb_func_start EntityD852_Update
EntityD852_Update: @ 0x080A6B88
	push {r4, lr}
	adds r3, r0, #0
	movs r1, #0
	ldrh r2, [r3, #0x18]
...
_080A6C02:
	...
	thumb_func_start EntityD852_Destroy
EntityD852_Destroy: @ 0x080A6C0C
	push {r4, r5, r6, lr}
	adds r6, r0, #0
	movs r5, #0
	ldrh r0, [r6, #0x1c]
...
_080A6C2C:
	...
	thumb_func_start EntityD852_Init
EntityD852_Init: @ 0x080A6C34
	push {lr}
	adds r1, r0, #0
	movs r0, #0
	strh r0, [r1, #0x18]
...
_080A6C50: .4byte 0x0000FD22
	...
	thumb_func_start EntityD852_Create
EntityD852_Create: @ 0x080A6C54
	push {r4, lr}
	movs r1, #0xb2
	lsls r1, r1, #2
	movs r0, #9
	...
	cmp r4, #0
	beq _080A6C8C
	ldr r1, _080A6C84 @ =EntityD852_Update
	ldr r2, _080A6C88 @ =EntityD852_Destroy
	bl SetEntityRoutine
	adds r0, r4, #0
	bl EntityD852_Init
	cmp r0, #0
	...
	b _080A6C8E
	.align 2, 0
_080A6C84: .4byte EntityD852_Update
_080A6C88: .4byte EntityD852_Destroy
_080A6C8C:
	adds r0, r4, #0
_080A6C8E:
	pop {r4}
