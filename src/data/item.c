...
const WeaponData gWeaponDB[66] = {
    ...
    {WEAPON_MORNING_STAR, WK_HAMMER, 2, 45, 30793, 0, 870, 0, 0, 0, 26, 0, 0},
...
//   id                        defence  weight  effectType  value  unk_5  price
    {ARMOR_CLOTH_ARMOR,        10,      5,      0,          0,     0,     50},
    {ARMOR_LEATHER_ARMOR,      15,      10,     0,          0,     0,     100},
    {ARMOR_CHAIN_MAIL,         20,      15,     0,          0,     0,     200},
    {ARMOR_SILVER_CHAIN,       25,      20,     1,          1,     0,     400},
    {ARMOR_SCALE_MAIL,         30,      25,     0,          0,     0,     800},
    {ARMOR_SAMURAI_ARMOR,      35,      30,     3,          2,     0,     1200},
    {ARMOR_BLADE_MAIL,         40,      35,     0,          0,     0,     1600},
    {ARMOR_BRIGANDINE,         45,      40,     4,          0,     0,     2000},
    {ARMOR_MAIL_OF_SOL,        25,      22,     5,          0,     0,     1750},
    {ARMOR_MAIL_OF_DARKNESS,   30,      22,     6,          0,     0,     1750},
    {ARMOR_MAIL_OF_LUNA,       25,      22,     12,         0,     0,     1750},
    {ARMOR_FIRE_DRAGON_FANG,   30,      33,     7,          0,     0,     750},
    {ARMOR_WATER_DRAGON_TAIL,  30,      33,     8,          0,     0,     750},
    {ARMOR_WIND_DRAGON_WING,   30,      33,     9,          0,     0,     750},
    {ARMOR_EARTH_DRAGON_CLAW,  30,      33,     10,         0,     0,     750},
    {ARMOR_DRAGON_SCALE,       28,      24,     11,         0,     0,     1000},
    {ARMOR_FAIRY_ROBE,         16,      4,      13,         200,   0,     500},
    {ARMOR_EARTHLY_ROBE,       28,      8,      14,         200,   0,     750},
    {ARMOR_RAIN_COAT,          12,      6,      15,         0,     0,     250},
    {ARMOR_GARB_OF_LIGHT,      30,      12,     16,         200,   0,     1250},
    {ARMOR_GARB_OF_DARKNESS,   30,      12,     17,         0,     0,     1250},
    {ARMOR_MAGIC_ROBE,         26,      16,     18,         20,    0,     750},
    {ARMOR_BLOOD_CAPE,         22,      12,     2,          2,     0,     750},
    {ARMOR_SKULL_SUIT,         20,      16,     19,         50,    0,     750},
    {ARMOR_TRAINING_GEAR,      25,      16,     20,         150,   0,     1000},
    {ARMOR_THIEF_CLOTHES,      18,      24,     21,         0,     0,     1000},
    {ARMOR_HUNTER_CLOTHES,     24,      24,     22,         0,     0,     100},
    {ARMOR_POISON_GUARD,       18,      28,     23,         0,     0,     250},
    {ARMOR_WEAPON_GUARD,       24,      28,     24,         0,     0,     500},
    {ARMOR_PARADE_ARMOR,       32,      28,     25,         0,     0,     750},
    {ARMOR_NINJA_GI,           18,      28,     26,         10,    0,     750},
    {ARMOR_SPIKE_MAIL,         40,      40,     27,         20,    0,     1500},
    {ARMOR_BLACK_ARMOR,        50,      50,     28,         20,    0,     1750},
    {ARMOR_MEGA_POWER,         25,      30,     29,         0,     0,     1500},
    {ARMOR_GUTS_POWER,         30,      40,     30,         0,     0,     1500},
    {ARMOR_PROTO_POWER,        25,      20,     31,         0,     0,     1500},
    {ARMOR_TOAD_POWER,         20,      20,     32,         0,     0,     1500},
};
// clang-format on
