...
typedef struct Entity08004facNode {
  ...
  u8 active;                        // 0x02, 1 なら tileOverride を衝突マップへ登録済み
...
NAKED void FUN_08004c78(void) { INCFUNC("asm/func/FUN_08004c78.inc"); }
...
NAKED s32 Entity08004fac_Update(Entity08004fac* p) { INCFUNC("asm/func/Entity08004fac_Update.inc"); }

NAKED s32 Entity08004fac_Destroy(Entity08004fac* p) { INCFUNC("asm/func/Entity08004fac_Destroy.inc"); }

NAKED s32 Entity08004fac_Init(Entity08004fac* p, u32 param_2) { INCFUNC("asm/func/Entity08004fac_Init.inc"); }
...
NAKED s32 FUN_08005004(void) { INCFUNC("asm/func/FUN_08005004.inc"); }

NAKED s32 FUN_0800501c(void) { INCFUNC("asm/func/FUN_0800501c.inc"); }
