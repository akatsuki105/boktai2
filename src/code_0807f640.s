...
_0807F926:
	...
	thumb_func_start FUN_0807f94c
FUN_0807f94c: @ 0x0807F94C
	push {r4, r5, r6, r7, lr}
	adds r4, r0, #0
	adds r5, r4, #0
	adds r5, #0xee
	...
	bne _0807F972
	movs r2, #4
	ldr r1, _0807F9C8 @ =0x030044BC
	ldr r0, [r1]
	orrs r0, r2
	str r0, [r1]
	ldr r0, _0807F9CC @ =0x00000302
	bl PlaySound_082406e0
	movs r0, #0xfd
	lsls r0, r0, #1
	bl PlaySound_082406e0
_0807F972:
	ldr r0, _0807F9D0 @ =0x03002BE0
	ldr r2, [r0]
	adds r1, r2, #0
	adds r1, #0x90
	ldr r0, [r1]
...
_0807F9C2:
	...
	bx r0
	.align 2, 0
_0807F9C8: .4byte 0x030044BC
_0807F9CC: .4byte 0x00000302
_0807F9D0: .4byte 0x03002BE0
_0807F9D4: .4byte FUN_0807f9d8
...
FUN_0807fe04: @ 0x0807FE04
	...
	thumb_func_start FUN_0807fe24
FUN_0807fe24: @ 0x0807FE24
	push {r4, r5, lr}
	adds r4, r0, #0
	adds r0, #0x3c
	bl FUN_0822f1c0
...
_08089820:
	...
	thumb_func_start FUN_08089828
FUN_08089828: @ 0x08089828
	push {r4, r5, lr}
	adds r4, r0, #0
...
_0808A99C: .4byte 0x00000A2F
	...
	thumb_func_start FUN_0808a9a0
FUN_0808a9a0: @ 0x0808A9A0
	bx lr
	.align 2, 0
...
_0808C766:
	...
	thumb_func_start FUN_0808c770
FUN_0808c770: @ 0x0808C770
	push {r4, lr}
	adds r2, r0, #0
	adds r1, r2, #0
	adds r1, #0x39
...
FUN_0808eeac: @ 0x0808EEAC
	...
	movs r0, #0xde
	bl PlaySound_082406e0
	ldr r1, _0808EEDC @ =FUN_0808eef8
	adds r0, r4, #0
	bl FUN_0808a33c
	b _0808EEF0
	.align 2, 0
_0808EED8: .4byte 0x000034E4
_0808EEDC: .4byte FUN_0808eef8
_0808EEE0:
	cmp r0, #1
	bne _0808EEF0
	movs r0, #0xdd
...
_0808EEF0:
	...
	thumb_func_start FUN_0808eef8
FUN_0808eef8: @ 0x0808EEF8
	push {r4, lr}
	adds r4, r0, #0
	ldr r0, _0808EF18 @ =0x000009EC
	adds r1, r4, r0
	ldrh r0, [r1]
	cmp r0, #0xf
	bhi _0808EF1C
	...
	b _0808EF24
	.align 2, 0
_0808EF18: .4byte 0x000009EC
_0808EF1C:
	movs r0, #0
	movs r1, #0
	bl FUN_0808a458
_0808EF24:
	ldr r1, _0808EF50 @ =0x000034E4
	adds r0, r4, r1
	adds r1, r4, #0
	adds r1, #0xc0
	bl FUN_082372cc
	ldr r0, _0808EF54 @ =0x000009EC
	adds r2, r4, r0
	ldrh r0, [r2]
	adds r1, r0, #1
	strh r1, [r2]
...
_0808EF48:
	...
	bx r0
	.align 2, 0
_0808EF50: .4byte 0x000034E4
_0808EF54: .4byte 0x000009EC
...
_0808F014:
	...
	thumb_func_start FUN_0808f01c
FUN_0808f01c: @ 0x0808F01C
	push {r4, lr}
	adds r4, r0, #0
	ldr r1, _0808F060 @ =0x000034E4
	adds r0, r4, r1
	adds r1, r4, #0
	adds r1, #0xc0
	bl FUN_082372cc
	ldr r0, _0808F064 @ =0x000009EC
	adds r1, r4, r0
	ldrh r0, [r1]
	adds r0, #1
	strh r0, [r1]
	...
	b _0808F078
	.align 2, 0
_0808F060: .4byte 0x000034E4
_0808F064: .4byte 0x000009EC
_0808F068: .4byte 0x00004022
_0808F06C: .4byte 0x00004028
_0808F070:
	movs r0, #0
	movs r1, #3
	bl FUN_08047c40
_0808F078:
	ldr r1, _0808F084 @ =FUN_0808f09c
	adds r0, r4, #0
	bl FUN_0808a33c
	b _0808F090
	.align 2, 0
_0808F084: .4byte FUN_0808f09c
_0808F088:
	ldr r1, _0808F098 @ =FUN_0809ae0c
	adds r0, r4, #0
	bl FUN_0808a33c
_0808F090:
	pop {r4}
