...
typedef struct {
  ...
  Player* player;      // 0x18
  MainSpriteGfx gfx;   // 0x1C, 根拠: LoadPlayerSprite_0807fe48
  MainSprite sprites;  // 0x3C, 根拠: FUN_0807fe24
  u8 unk_9c[1220 - 0x9C];
} Entity11_080801b0;
...
NAKED void LoadPlayerSprite_0807fe48(Entity11_080801b0* p) { INCFUNC("asm/func/LoadPlayerSprite_0807fe48.inc"); }
