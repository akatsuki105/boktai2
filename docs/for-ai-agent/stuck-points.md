...
- `FUN_08230134` (`src/sprite_main_arm.c`) — ARM ステート
...
- `Entity0800a89c_PurifyDarkBugs` (`src/spirit_bugs.c`)
- `Entity0800a89c_UpdateCollectedBug` (`src/spirit_bugs.c`)
...
- `FUN_080f3cdc` (`src/enemy_080ef84c.c`)
- `FUN_0823e828` (`src/time.c`)
- `FUN_0823e470` (`src/time.c`)
- `FUN_08022704` (`src/entity_730a.c`)
- `FUN_08022770` (`src/entity_730a.c`)
- `FUN_080227f4` (`src/entity_730a.c`)
- `Entity730A_Update_Helper_08022864` (`src/entity_730a.c`)
- `TextBoxChoice_ScanChoices` (`src/textbox_choice.c`)
- `TextBoxChoice_HandleInput` (`src/textbox_choice.c`)
- `TextBoxChoice_ParseTag` (`src/textbox_choice.c`)
- `MapItem_UpdateShake` (`src/map_item.c`)
- `MapItem_ExecScript` (`src/map_item.c`)
- `MapItemManager_Init` (`src/map_item.c`)
- `MapItem_UpdateIdle` (`src/map_item.c`)
- `EntityF41A_OnMessage` (`src/entity_f41a.c`)
- `EntityF41A_UpdateWander` (`src/entity_f41a.c`)
- `EntityF41A_UpdateKnockback` (`src/entity_f41a.c`)
- `EntityCF82_Update` (`src/entity_cf82.c`)
- `ClockAlarm_Update` (`src/entity_ace3.c`)
- `FUN_0822d630` (`src/video.c`)
- `FUN_0822d014` (`src/video.c`)
- `SetBGCharBaseDirect` (`src/video.c`)
- `Video_RestoreWindowRect` (`src/video.c`)
