...
export const getSubroutineTable = (rom: DataView): SubroutineEntry[] => {
  ...
  return ParseSubroutineTable(rom, start, length);
};

const ParseSubroutineTable = (rom: DataView, start: addr, length: number): SubroutineEntry[] => {
